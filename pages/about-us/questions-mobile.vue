<script setup lang="ts">
  ...
  const { productRes } = await useProductMeta("about-us/questions");

  useAppSeo({
    title: "Frequently Asked Questions (FAQ)",
    ogTitle: "Frequently Asked Questions (FAQ)",
    ogUrl: localePath("/about-us/questions-mobile"),
  });
  ...
  <div>
    <WithSidebarLayout>
      <template #sidebar>
        <AppSidebarList
          v-if="questions"
          :title="productRes.SubPage.SidebarTitle"
          :lists="
          ...
          :selected="questions.data[0].Id.toString()"
          :as-link="false"
      ...
      <template #default>
        <div v-if="questions && questions.data.length">
          ...
          <div
            v-for="questionGroup in questions.data"
            :id="`question-group-${questionGroup.Id}`"
            :key="questionGroup.Id"
            class="question-group mb-5"
          >
            ...
            <div
              ...
              :key="question.Id"
              class="d-block question mb-4"
            >
              <div
                class="collapsed cursor-pointer justify-content-between d-flex py-1"
              ...
              >
                ...
                <span class="question__arrow text-primary">
                  <i
                    v-show="visibleItems.has(`#question-${question.Id}`)"
              ...
              <div :id="'question-' + question.Id" class="accordion-collapse collapse">
                <AppText color="black" :size="undefined" class="question__answer">{{
                  question.Answer
                }}</AppText>
              </div>
            </div>
